...
* .row  A and D 
varV.1='tb.1(x=5)-tb.1(x=3)' 
varH.1='tb.2(x=5)-tb.2(x=3)' 
varV.2='tb.3(x=5)-tb.3(x=3)' 
varH.2='tb.4(x=5)-tb.4(x=3)' 
...
* .row
ttl.1='Tb36-Tb18 Asdg'
ttl.2='Tb36-Tb18 Dsdg'
...
'printim 1x2-Tb-grdnt-04-07-'reg.1.ipage'.gif white x2400 y1600' 
'printim 1x2-Tb-grdnt-04-07-'reg.1.ipage'-sm.gif white x1200 y800' 
'printim 1x2-Tb-grdnt-04-07-'reg.1.ipage'-icn.gif white x320 y210' 
