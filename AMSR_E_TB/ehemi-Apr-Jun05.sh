...
#X is varying   Lon = 0.125 to 179.875   X = 721 to 1440
#Y is varying   Lat = -89.875 to 89.875   Y = 1 to 720

for orb in A D; do 
 for pol in V H; do 
  ofile=ehemi-${pol}${orb}-Apr-Jun05.dat
  ./Tb-spectra-area $pol $orb 2005 4 1 2005 6 30 -89.875 0.125 89.875 179.875 $ofile 

cat > spectra-ehemi-${pol}${orb}-Apr-Jun05.ctl <<EOF

DSET       ^$ofile 
TITLE       AMSR-E TB, ehemi, $pol-Pol, $orb-Pass 
OPTIONS     big_endian 
UNDEF       0
XDEF        720 LINEAR           0.125    0.25
