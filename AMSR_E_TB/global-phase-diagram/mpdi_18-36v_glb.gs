...
* ocean
  'set ccolor 22'
 'd maskout(mean, 0.5-mask.3(t=1));maskout(mean.2, 0.5-mask.3(t=1))'
* land
  'set ccolor 28'
...
'gxyat -x 2400 -y 2000 glb_mpdi_18-36_phase-'sn.is'-'ps.ip'.png' 
'gxyat -x 1200  -y 1000 glb_mpdi_18-36_phase-'sn.is'-'ps.ip'-sm.png' 
