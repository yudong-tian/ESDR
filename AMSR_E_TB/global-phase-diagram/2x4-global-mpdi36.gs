* Display mean and stdev for mpdi and mpdi36 
...
clev.2.1='0 5 10 15 20 25 30 35 40 45 50 55 60 65' 
...
'gxyat -x 2000 -y 2800 2x4-'var.iv'-'ps.ip'-mpdi36.png' 
'gxyat -x 1000  -y 1400 2x4-'var.iv'-'ps.ip'-mpdi36-sm.png' 
