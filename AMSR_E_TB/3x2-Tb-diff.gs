...
while (ireg <= regs)
 ...
 'open /home/ytian/lswg/LIS-MEM/tests/output/UMBC-Tba.ctl'
...
'printim 3x2-Tb-diff-'reg.ireg'.gif white x2400 y1200' 
'printim 3x2-Tb-diff-'reg.ireg'-sm.gif white x1200 y600' 
